...
view: amq_s_suivi_evo_historization_silver {
  sql_table_name: `irn-79023-lqd-dat-ope-05.db_domainrestricted_irn_79023_lqd_lup_quality_data.suivi_evo_historization_silver` ;;
...
# ── ARRAY VIEWS ─────────────────────────────────────────────────
view: suivi_evo_historization_silver__vies_requesting_teams {
  dimension: suivi_evo_historization_silver__vies_requesting_teams {
    type: string
...
view: suivi_evo_historization_silver__vies_component_names {
  dimension: suivi_evo_historization_silver__vies_component_names {
    type: string
...
view: suivi_evo_historization_silver__capitams_component_names {
  dimension: suivi_evo_historization_silver__capitams_component_names {
    type: string
