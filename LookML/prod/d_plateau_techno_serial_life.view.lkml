...
view: d_plateau_techno_serial_life {
  sql_table_name: `irn-79023-lqd-dat-ope-05.db_domainrestricted_irn_79023_lqd_lup_quality_data.capitalization_gold` ;;
...
# Ligne à changer: preprod / prod
view: d_plateau_techno_serial_life__vies_component_names {
  dimension: d_plateau_techno_serial_life__vies_component_names {
    type: string
...
view: d_plateau_techno_serial_life__vies_requesting_teams {
  dimension: d_plateau_techno_serial_life__vies_requesting_teams {
    type: string
...
view: d_plateau_techno_serial_life__capitams_component_names {
  dimension: d_plateau_techno_serial_life__capitams_component_names {
    type: string
    description: "List of component names"
    sql: ${TABLE} ;;
  }
