...
view: d_plateau_techno_serial_life_evo_historization_gold {
  sql_table_name: `irn-79023-lqd-dat-ope-05.db_domainrestricted_irn_79023_lqd_lup_quality_data.suivi_evo_historization_gold` ;;
...
# bien faire attention (1/1) 
  ...
  measure: count_vies_ready {
    ...
    drill_fields: [snapshot_week, vies_ticket_id, vies_url, vies_domain, domain_group, vies_criticity, vies_status, capitams_key, capitams_url]
  }
  ...
  measure: count_capitams_created {
    ...
    drill_fields: [snapshot_week, vies_ticket_id, vies_url, vies_domain, domain_group, vies_criticity, capitams_key, capitams_url, capitams_status, capitams_criticity, capitams_capitalization_status]
  }
  ...
  measure: count_nrl_npk {
    ...
    drill_fields: [snapshot_week, vies_ticket_id, vies_url, vies_domain, domain_group, vies_criticity, capitams_key, capitams_url, capitams_nrl, nrl_date_statut_valide, capitams_capitalization_status]
  }
...
view: suivi_evo_historization_gold__vies_requesting_teams {
  dimension: suivi_evo_historization_gold__vies_requesting_teams {
    type: string
...
view: suivi_evo_historization_gold__vies_component_names {
  dimension: suivi_evo_historization_gold__vies_component_names {
    type: string
...
view: suivi_evo_historization_gold__capitams_component_names {
  dimension: suivi_evo_historization_gold__capitams_component_names {
    type: string
