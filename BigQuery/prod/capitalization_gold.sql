...
preprocessed_vies AS (
  SELECT *
  FROM `irn-79023-lqd-dat-ope-05.db_private_irn_79023_lqd_lup_quality_data.preprocessing_VIES_production`
),
...
preprocessed_capitams AS (
  SELECT *
  FROM `irn-79023-lqd-dat-ope-05.db_private_irn_79023_lqd_lup_quality_data.preprocessing_CAPITAMS_production`
),
...
preprocessing_nrl AS (
  SELECT *
  FROM `irn-79023-lqd-dat-ope-05.db_private_irn_79023_lqd_lup_quality_data.preprocessing_NRL_production`
)
